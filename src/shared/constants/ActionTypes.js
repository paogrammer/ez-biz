...
export const INVENTORY_ACTION_TYPES = {
  GET_INVENTORIES: {
    IS_FETCHING: 'GET_INVENTORIES_DATA_IS_FETCHING',
    IS_FETCHED: 'GET_INVENTORIES_DATA_IS_FETCHED',
    IS_ERROR: 'GET_INVENTORIES_DATA_IS_ERROR',
  },
  ADD_INVENTORY: {
    IS_FETCHING: 'ADD_INVENTORIES_DATA_IS_FETCHING',
    IS_FETCHED: 'ADD_INVENTORIES_DATA_IS_FETCHED',
    IS_ERROR: 'ADD_INVENTORIES_DATA_IS_ERROR',
  },
  UPDATE_INVENTORY: {
    IS_FETCHING: 'UPDATE_INVENTORIES_DATA_IS_FETCHING',
    IS_FETCHED: 'UPDATE_INVENTORIES_DATA_IS_FETCHED',
    IS_ERROR: 'UPDATE_INVENTORIES_DATA_IS_ERROR',
  },
  DELETE_INVENTORY: {
    IS_FETCHING: 'DELETE_INVENTORIES_DATA_IS_FETCHING',
    IS_FETCHED: 'DELETE_INVENTORIES_DATA_IS_FETCHED',
    IS_ERROR: 'DELETE_INVENTORIES_DATA_IS_ERROR',
  },
};
...
export const ORDERS_ACTION_TYPES = {
  GET_ORDERS: {
    IS_FETCHING: 'GET_ORDERS_DATA_IS_FETCHING',
    IS_FETCHED: 'GET_ORDERS_DATA_IS_FETCHED',
    IS_ERROR: 'GET_ORDERS_DATA_IS_ERROR',
  },
  ADD_ORDER: {
    IS_FETCHING: 'ADD_ORDERS_DATA_IS_FETCHING',
    IS_FETCHED: 'ADD_ORDERS_DATA_IS_FETCHED',
    IS_ERROR: 'ADD_ORDERS_DATA_IS_ERROR',
  },
  UPDATE_ORDER: {
    IS_FETCHING: 'UPDATE_ORDERS_DATA_IS_FETCHING',
    IS_FETCHED: 'UPDATE_ORDERS_DATA_IS_FETCHED',
    IS_ERROR: 'UPDATE_ORDERS_DATA_IS_ERROR',
  },
  DELETE_ORDER: {
    IS_FETCHING: 'DELETE_ORDERS_DATA_IS_FETCHING',
    IS_FETCHED: 'DELETE_ORDERS_DATA_IS_FETCHED',
    IS_ERROR: 'DELETE_ORDERS_DATA_IS_ERROR',
  },
};

// DASHBOARD
export const DASHBOARD_ACTION_TYPES = {
  IS_FETCHING: 'GET_DASHBOARD_DATA_IS_FETCHING',
  IS_FETCHED: 'GET_DASHBOARD_DATA_IS_FETCHED',
  IS_ERROR: 'GET_DASHBOARD_DATA_IS_ERROR',
};
